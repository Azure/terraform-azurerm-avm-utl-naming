...
Description: Slug overrides keyed by the snake-case JSON catalog key. Overrides take precedence over legacy\_mode and catalog defaults. Null uses the selected defaults; an empty string omits the slug.
